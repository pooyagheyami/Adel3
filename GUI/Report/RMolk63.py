...
class MyPanel1 ( wx.Panel ):
	...
	def bkmlk( self, event ):
                l = len(self.lstmlk)
                nl = self.lstmlk.index(self.mcod) 
                nl = nl + 1
                if nl == l:
                    nl = 0
                self.mcod = self.lstmlk[nl]
                self.setdata(self.mcod)
                #print 'plus',nl 
		#event.Skip()
	
	def frmlk( self, event ):
                l = len(self.lstmlk)
                nl = self.lstmlk.index(self.mcod) 
                nl = nl - 1
                if nl < 0:
	...
	def savit( self, event ):
        ...
        def GnSpc( self , data ):
                Rdata = []
                #D = [1,F,0,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,0,F]#5 pnl1
                #D = [T,T,T,T,T,T,T,T,T,T,1,T,T,T,T,T]#7 pnl2
                #D = [False,False,False,False]#8 pnl3
                #print data
...
class MyPanel4 ( wx.Panel ):
	...
	def __init__( self, parent , txts ):
		...
		self.fld11 = wx.TextCtrl( self, 313, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_ENTER|wx.STATIC_BORDER )
		...
		self.fld10 = wx.TextCtrl( self, 312, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_ENTER|wx.STATIC_BORDER )
		...
		self.fld14 = wx.TextCtrl( self, 316, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE|wx.TE_PROCESS_ENTER|wx.TE_RIGHT|wx.STATIC_BORDER )
